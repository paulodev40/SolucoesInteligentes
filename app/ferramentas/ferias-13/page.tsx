...
export const metadata: Metadata = {
  title: 'Calculadora de Férias e 13º Salário 2025 — Gratuita',
  description:
    'Calcule férias com terço constitucional e 13º salário proporcional com desconto de INSS e IRRF. Calculadora trabalhista gratuita e atualizada para 2025.',
