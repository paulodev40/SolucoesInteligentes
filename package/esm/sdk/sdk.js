...
export class Vercel extends ClientSDK {
     ...
     */
    async patchV1ProjectsProjectIdRollbackDeploymentIdUpdateDescription(request, options) {
        return unwrapAsync(patchV1ProjectsProjectIdRollbackDeploymentIdUpdateDescription(this, request, options));
    }
}
