...
import { marketplaceGetV1InstallationsIntegrationConfigurationIdResourcesResourceIdExperimentationEdgeConfig, } from "../funcs/marketplaceGetV1InstallationsIntegrationConfigurationIdResourcesResourceIdExperimentationEdgeConfig.js";
...
export class Marketplace extends ClientSDK {
     ...
     * When the user enabled Edge Config syncing, then this endpoint can be used by the partner to fetch the contents of the Edge Config.
     */
    async getV1InstallationsIntegrationConfigurationIdResourcesResourceIdExperimentationEdgeConfig(request, options) {
        return unwrapAsync(marketplaceGetV1InstallationsIntegrationConfigurationIdResourcesResourceIdExperimentationEdgeConfig(this, request, options));
    }
    /**
