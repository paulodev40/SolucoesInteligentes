...
export class Billing extends ClientSDK {
     ...
     */
    async listBillingCharges(request, options) {
        return unwrapAsync(billingListBillingCharges(this, request, options));
    }
    /**
     ...
     */
    async listContractCommitments(request, options) {
        return unwrapAsync(billingListContractCommitments(this, request, options));
    }
}
