...
it.skip("Domains Buy Domain", async () => {
    assert.fail("incomplete test found please make sure to address the following errors: [`workflow step buyDomain.test referencing operation buyDomain not found in document`]");
});
it.skip("Domains Check Domain Price", async () => {
    assert.fail("incomplete test found please make sure to address the following errors: [`workflow step checkDomainPrice.test referencing operation checkDomainPrice not found in document`]");
});
it.skip("Domains Check Domain Status", async () => {
    assert.fail("incomplete test found please make sure to address the following errors: [`workflow step checkDomainStatus.test referencing operation checkDomainStatus not found in document`]");
});
it.skip("Domains Get Domain Transfer", async () => {
    assert.fail("incomplete test found please make sure to address the following errors: [`workflow step getDomainTransfer.test referencing operation getDomainTransfer not found in document`]");
});
