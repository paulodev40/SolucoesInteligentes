...
export const ResponseBodyFunctions$inboundSchema = z.object({
    ...
    experimentalTriggers: types.optional(z.array(z.lazy(() => ResponseBodyExperimentalTriggers$inboundSchema))),
...
/** @internal */
export const ResponseBodyDefault$inboundSchema = z.nativeEnum(ResponseBodyDefault);
/** @internal */
export const ResponseBodyDefault$outboundSchema = ResponseBodyDefault$inboundSchema;
/** @internal */
