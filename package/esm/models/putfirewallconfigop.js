...
/** @internal */
export const Value$inboundSchema = smartUnion([types.string(), z.array(types.string()), types.number()]);
/** @internal */
export const Value$outboundSchema = smartUnion([z.string(), z.array(z.string()), z.number()]);
...
/** @internal */
export const RateLimitAction$inboundSchema = smartUnion([Action1$inboundSchema, z.any()]);
/** @internal */
...
/** @internal */
export const RateLimit$inboundSchema = smartUnion([z.lazy(() => RateLimit1$inboundSchema), z.any()]);
/** @internal */
...
/** @internal */
export const PutFirewallConfigRedirect$inboundSchema = smartUnion([z.lazy(() => Redirect1$inboundSchema), z.any()]);
/** @internal */
...
export const Mitigate$inboundSchema = z.object({
    ...
    rateLimit: z.nullable(smartUnion([z.lazy(() => RateLimit1$inboundSchema), z.any()])).optional(),
    redirect: z.nullable(smartUnion([z.lazy(() => Redirect1$inboundSchema), z.any()])).optional(),
...
/** @internal */
export const ValidationErrors$inboundSchema = smartUnion([z.array(types.string()), types.string()]);
/** @internal */
...
export const PutFirewallConfigRequestBody$inboundSchema = z.object({
    ...
    rules: types.optional(z.array(z.lazy(() => PutFirewallConfigRules$inboundSchema))),
...
/** @internal */
export const PutFirewallConfigRulesValue$outboundSchema = smartUnion([z.string(), z.number(), z.array(z.string())]);
...
/** @internal */
export const PutFirewallConfigRulesSecurityValue$outboundSchema = smartUnion([z.string(), z.number(), z.array(z.string())]);
...
/** @internal */
export const PutFirewallConfigSecurityRules$outboundSchema = smartUnion([
...
/** @internal */
export const PutFirewallConfigSecurityResponse200ApplicationJSONResponseBodyActiveManagedRulesVercelRulesetAction$outboundSchema = PutFirewallConfigSecurityResponse200ApplicationJSONResponseBodyActiveManagedRulesVercelRulesetAction$inboundSchema;
/** @internal */
...
/** @internal */
export const PutFirewallConfigVercelRuleset$outboundSchema = z.object({
    active: z.boolean(),
    action: PutFirewallConfigSecurityResponse200ApplicationJSONResponseBodyActiveManagedRulesVercelRulesetAction$outboundSchema
        .optional(),
    updatedAt: z.string().optional(),
    userId: z.string().optional(),
    username: z.string().optional(),
});
export function putFirewallConfigVercelRulesetToJSON(putFirewallConfigVercelRuleset) {
    return JSON.stringify(PutFirewallConfigVercelRuleset$outboundSchema.parse(putFirewallConfigVercelRuleset));
}
