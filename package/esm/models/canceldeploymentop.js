...
export const CancelDeploymentFunctions$inboundSchema = z.object({
    ...
    experimentalTriggers: types.optional(z.array(z.lazy(() => CancelDeploymentExperimentalTriggers$inboundSchema))),
...
/** @internal */
export const CancelDeploymentDefault$inboundSchema = z.nativeEnum(CancelDeploymentDefault);
/** @internal */
export const CancelDeploymentDefault$outboundSchema = CancelDeploymentDefault$inboundSchema;
/** @internal */
