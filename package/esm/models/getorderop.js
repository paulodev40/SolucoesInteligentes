...
/** @internal */
export const GetOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details$inboundSchema = z.object({
    numDaysUntilTransferrable: types.number(),
});
/** @internal */
export const GetOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details$outboundSchema = z.object({
    numDaysUntilTransferrable: z.number(),
});
export function getOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2DetailsToJSON(getOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details) {
    return JSON.stringify(GetOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details$outboundSchema
        .parse(getOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details));
}
export function getOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2DetailsFromJSON(jsonString) {
    return safeParse(jsonString, (x) => GetOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details$inboundSchema
        .parse(JSON.parse(x)), `Failed to parse 'GetOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details' from JSON`);
}
/** @internal */
export const GetOrder14$inboundSchema = z.object({
    code: types.literal("cannot-transfer-in-until"),
    details: z.lazy(() => GetOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details$inboundSchema),
});
/** @internal */
export const GetOrder14$outboundSchema = z.object({
    code: z.literal("cannot-transfer-in-until"),
    details: z.lazy(() => GetOrder1DomainsRegistrarResponse200ApplicationJSONResponseBodyDomains2Details$outboundSchema),
});
