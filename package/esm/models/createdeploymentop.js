...
export const Functions$inboundSchema = z.object({
    ...
    experimentalTriggers: types.optional(z.array(z.lazy(() => ExperimentalTriggers$inboundSchema))),
...
/** @internal */
export const Has$inboundSchema = z.union([
...
/** @internal */
export const Routes$inboundSchema = smartUnion([
    z.lazy(() => Routes3$inboundSchema),
    z.lazy(() => Routes1$inboundSchema),
    z.lazy(() => Routes2$inboundSchema),
]);
/** @internal */
export const Routes$outboundSchema = smartUnion([
...
/** @internal */
export const CreateDeploymentDefault$inboundSchema = z.nativeEnum(CreateDeploymentDefault);
/** @internal */
export const CreateDeploymentDefault$outboundSchema = CreateDeploymentDefault$inboundSchema;
/** @internal */
