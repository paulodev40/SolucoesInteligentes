...
/** @internal */
export const Route$inboundSchema = smartUnion([
    z.lazy(() => Route1$inboundSchema),
    z.lazy(() => Route2$inboundSchema),
]);
/** @internal */
export const Route$outboundSchema = smartUnion([
...
export const CreateProjectResponseBody$inboundSchema = z.object({
    ...
    targets: types.optional(z.record(types.nullable(z.lazy(() => Targets$inboundSchema)))),
